sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return Controller.extend("com.apptech.realestate.controller.BusinessPartner", {
		...
		onInit: function () {
			...
			$.ajax({
				url: "/rexsjs/public/rexsjs/ExecQuery.xsjs?dbName=APP_RE&procName=SPAPP_RE_CUSTOMER&queryType=GETBPSTATUS&colValue=&colValue2=",
				type: "GET",
				xhrFields: {
		...
		prepareTable: function (bIsInit) {
			$.ajax({
				url: "/rexsjs/public/rexsjs/ExecQuery.xsjs?dbName=APP_RE&procName=SPAPP_RE_CUSTOMER&queryType=GETALLCUSTOMERS&colValue=&colValue2=",
				type: "GET",
				xhrFields: {
					withCredentials: true
				},
		...
		onEdit: function (oEvent) {
			...
			if (iIndex !== -1) {
				...
				//AJAX selected Key
				$.ajax({
					url: "/rexsjs/public/rexsjs/ExecQuery.xsjs?dbName=APP_RE&procName=SPAPP_RE_CUSTOMER&tableName=" + sQueryTable +
						"&colValue=" + sCode + 
						"&colValue2=" + "",
					type: "GET",
					xhrFields: {
				...
				sQueryTable = "GET_ONEDIT_CUSTOMERDOC";
				$.ajax({
					url: "/rexsjs/public/rexsjs/ExecQuery.xsjs?dbName=APP_RE&procName=SPAPP_RE_CUSTOMER&queryType=" + sQueryTable +
						"&colValue=" + sCode + 
						"&colValue2=" + "",
					type: "GET",
					xhrFields: {
					...
					var jsonDOC = JSON.stringify(results).replace("[", "").replace("]", "");
