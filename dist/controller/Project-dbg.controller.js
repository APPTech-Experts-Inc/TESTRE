sap.ui.define([
	...
	return Controller.extend("com.apptech.realestate.controller.Project", {
		...
		prepareTable: function (bIsInit) {
			$.ajax({
				url: "/rexsjs/public/rexsjs/ExecQuery.xsjs?dbName=APP_RE&procName=SPAPP_RE_GETPROJECTDATA&keyCode=&queryType=GetAllProject",
				type: "GET",
				xhrFields: {
					withCredentials: true
				},
		...
		onEdit: function (oEvent) {
			...
			var sQueryType = "GetSpecificProject";
			var sCode = "";
			if (iIndex !== -1) {
				...
				//AJAX selected Key
				$.ajax({
					url: "/rexsjs/public/rexsjs/ExecQuery.xsjs?dbName=APP_RE&procName=SPAPP_RE_GETPROJECTDATA&keyCode=" +
